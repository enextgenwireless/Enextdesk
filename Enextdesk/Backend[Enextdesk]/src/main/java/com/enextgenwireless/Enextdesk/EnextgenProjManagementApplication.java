...
import com.enextgenwireless.Enextdesk.auth.util.AuditorAwareImpl;
...
@EnableAsync
@Log
public class EnextgenProjManagementApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(EnextgenProjManagementApplication.class, args);
    }
