...
import com.enextgenwireless.Enextdesk.event.repo.IssueEventRepo;
import com.enextgenwireless.Enextdesk.event.service.EmailService;
import com.enextgenwireless.Enextdesk.issues.domain.*;
import com.enextgenwireless.Enextdesk.issues.repo.*;
import com.enextgenwireless.Enextdesk.issues.service.IssueAsyncService;
import com.enextgenwireless.Enextdesk.project.domain.SlackChannel;
...
public class IssueEventHandler {
    ...
    public String jsonData(Issue issue) {
        ...
        jsonData.put("component", issue.getComponents().stream().map(com.enextgenwireless.Enextdesk.project.domain.Component::getId).collect(Collectors.toList()));
